    ...
    <>
      <nav className="block w-full  px-4  py-3 mx-auto text-blue-gray-900 shadow-lg border-b-2 bg-white">
        <div className="flex flex-wrap items-center justify-between text-blue-gray-900 gap-y-4">
          <Link
            to="/"
            className="mr-4 ml-10 md:ml-14 block cursor-pointer py-1.5 font-sans text-base font-semibold leading-relaxed tracking-normal text-inherit antialiased"
          >
            Flowbite
          </Link>
          <div className="relative  items-center hidden md:flex justify-center m-auto w-1/2 gap-2 ">
            <div className="relative flex-grow">
              <input
                type="search"
                className=" h-full w-full rounded-[7px] border border-blue-gray-500 bg-transparent px-3 py-2.5 pr-20 font-sans text-sm font-normal text-blue-gray-900 outline outline-0 transition-all placeholder-shown:border placeholder-shown:border-blue-gray-500 focus:border-gray-900 disabled:border-0 disabled:bg-blue-gray-50"
          ...
          <div className="flex gap-1 ml-auto md:mr-4">
            ...
            >
              <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <IoBagHandleSharp className="w-4 h-4 md:w-6 md:h-6" />
              </span>
            </Link>
            <Link
              to="/cart-page"
            ...
            >
              <span className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                <CgShoppingCart className="w-4 h-4 md:w-6 md:h-6" />
              </span>
              {cartCount > 0 && (
          ...
          <div className="relative flex md:hidden items-center justify-center w-full gap-2 md:w-max">
            <div className="relative flex-grow">
              <input
                type="search"
